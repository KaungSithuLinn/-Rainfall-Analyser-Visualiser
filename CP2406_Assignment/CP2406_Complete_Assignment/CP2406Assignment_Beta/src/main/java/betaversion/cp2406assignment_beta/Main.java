...
public class Main extends Application {
    ...
    private void buildHomeStage() {
        ...
        Label message = new Label("Hello and welcome to the Rainfall Visualizer.");
        ...
        startButton.setStyle("-fx-font-size: 14px; -fx-background-color: #4CAF50; -fx-text-fill: white; -fx-padding: 10px;");

        Button loadButton = new Button("Load Rainfall Data");
        loadButton.setStyle("-fx-font-size: 14px; -fx-background-color: #008CBA; -fx-text-fill: white; -fx-padding: 10px;");

        Button quitButton = new Button("Quit");
        quitButton.setStyle("-fx-font-size: 14px; -fx-background-color: #f44336; -fx-text-fill: white; -fx-padding: 10px;");
        ...
        homeRoot.setStyle("-fx-border-width: 2px; -fx-border-color: #AA96DA");

        // Build the home scene and assign it to the home stage.
        Scene homeScene = new Scene(homeRoot, 600, 400);
        homeStage.setScene(homeScene);
        homeStage.setTitle("CP2406 Assignment - KaungSithuLinn ");
